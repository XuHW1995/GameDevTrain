...
namespace Cinemachine
{
    ...
    public class CinemachineCollider : CinemachineExtension
    {
            ...
            CinemachineCore.Stage stage, ref CameraState state, float deltaTime)
        {
            ...
            {   
                if (state.PositionCorrection.y < m_OptimalTargetDistance)
                {   
                    var pos = state.PositionCorrection;
                    state.PositionCorrection = new Vector3( pos.x, this.m_OptimalTargetDistance ,pos.z );
                }
            }   
        }
