...
//					if (checkpointManager.thereIsLastCheckpoint ()) {
...
//					
//							playerComponentsManager currentPlayerControllerManager = playerControllerManager.GetComponent<playerComponentsManager> ();
//
